...
Run: python scripts/wordcount.py --budget 30000 manuscript

Counts prose only: code fences, HTML/Mermaid tags, and heading marks are
stripped, and image/link syntax is reduced to its visible text. The number will
be a little lower than a naive `wc -w`, which is the point.
"""
import argparse
import re
import sys
