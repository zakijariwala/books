"""Normalize a rendered figure to print spec: grayscale, fits the text block.
...
A print interior is black and white, so images are converted to grayscale here.
...
If you change the trim size, change TARGET_WIDTH and MAX_HEIGHT to match the new
text block, and re-render every figure. Keep this in step with
make_reference_docx.py and figstyle.py.
"""
import sys
