...
| 7 | 7 | not yet drafted | Someone saw data that was not there yet. The read replica sentence, answered. | This is the chapter `docs/toc-review.md` calls the moment the reader trusts the book. | OPEN |
| 8 | 8 | not yet drafted | The traffic event that was planned for, or was not. | Undetermined until ch8 is drafted. | OPEN |
