...
docs/buyer.md, docs/chapter-template.md, and CLAUDE.md. Run vale on the file.
...
4. BORROWED WEIGHT. Count the borrowed case studies against the first-hand
   material. Flag if borrowed exceeds half.
5. VOICE BREAKS. Vale output plus anything Vale cannot catch. Quote and fix.
